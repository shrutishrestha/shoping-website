    ...
    <table>
        ...
        <tr>
            ...
            <g:sortableColumn property="message"
                              title="${message(code: 'customer.message.label', default: 'Message')}"/>
        ...
        <g:each in="${customerInstanceList}" status="i" var="customerInstance">
            <tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
                ...
                <td><g:link action="show"
                            id="${customerInstance.id}">${fieldValue(bean: customerInstance, field: "email")}</g:link></td>

                <td>${fieldValue(bean: customerInstance, field: "message")}</td>
