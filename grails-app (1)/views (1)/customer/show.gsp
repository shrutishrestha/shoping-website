...
<div id="show-customer" class="content scaffold-show" role="main">
    ...
    <ol class="property-list customer">
        ...
        <g:if test="${customerInstance?.message}">
            <li class="fieldcontain">
                <span id="message-label" class="property-label"><g:message code="customer.message.label"
                                                                           default="Message"/></span>

                <span class="property-value" aria-labelledby="message-label"><g:fieldValue bean="${customerInstance}"
                                                                                           field="message"/></span>
