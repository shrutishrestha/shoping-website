...
%{--<div style="padding:50px;">--}%
    ...
    %{--<g:form method="post" action="loginUser" controller="login">--}%
        ...
        %{--<p>Role:<g:field type="role" name="role" value="" placeholder="role"/></p><br>--}%

        %{--<p class="submit"><g:submitButton value="Signup" name="submit" /></p><br>--}%
    %{--</g:form>--}%
%{--</div>--}%
%{--Have account sign in: <g:link action="login" controller="login">Login</g:link>--}%
