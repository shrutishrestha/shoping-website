...
class ProductController extends BaseController {
    ...
    def save() {
        ...
        public void uploadFile(def params){
            final String realFilePath=grailsApplication.mainContext.servletContext.getRealPath("");
            MultipartHttpServletRequest mtr=(MultipartHttpServletRequest) request;
            CommonsMultipartFile file=(CommonsMultipartFile) mtr.getFile("image");
            if(file){
                file.transferTo(new File(realFilePath+"/products/${file.getOriginalFilename()}"));
                params.imageName=file.originalFilename;
                params.remove("image");
            }
        }
